<template>
  <section class="hero-section relative min-h-screen flex items-center">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        class="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-habit-hero-glow opacity-60"
      ></div>
      <div
        class="absolute bottom-0 left-0 right-0 h-1/3 bg-habit-gradient-dark"
      ></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <!-- Subtitle -->
      <p
        class="hero-subtitle animate-fade-in-up mb-10"
      ...
      <div
        ...
        class="mt-16 flex flex-wrap justify-center gap-8 md:gap-16 animate-fade-in-up"
    ...
    >
      <svg
        class="w-6 h-6 text-habit-text-muted"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
...
withDefaults(defineProps<Props>(), {
  ...
  primaryAction: "Start tracking for free",
